<template>
  <div class="cu-skeleton-item" :class="shape ? 'is-' + shape : undefined" :style="{ '--cu-skeleton-size': size }">
    <svg viewBox="0 0 1024 1024" p-id="7083" width="20%" height="20%" v-if="shape === 'image'">
      <path d="M287.8 288m-96 0a96 96 0 1 0 192 0 96 96 0 1 0-192 0Z" fill="#d6d6d6" p-id="7084"></path>
      <path
...
defineProps({
  shape: {
    type: String as PropType<'circle' | 'image' | 'row'>,
    default: 'row'
  },
  size: Number
});
