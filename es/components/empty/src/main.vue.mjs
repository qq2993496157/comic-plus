import { defineComponent, openBlock, createElementBlock, createElementVNode, normalizeStyle, renderSlot, toDisplayString } from "vue";
import "../style/empty.css";
import { emptyProps } from "./main.props.mjs";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createElementVNode("div", {
          ...
          style: normalizeStyle({ "--cu-empty-imagesize": _ctx.imageSize ? _ctx.imageSize + "px" : void 0 })
        }, [
          renderSlot(_ctx.$slots, "img", {}, () => [
            _ctx.image ? (openBlock(), createElementBlock("img", {
              key: 0,
              src: _ctx.image
            }, null, 8, _hoisted_2)) : (openBlock(), createElementBlock("svg", _hoisted_3, _hoisted_10))
          ])
        ], 4),
        createElementVNode("div", _hoisted_11, toDisplayString(_ctx.description), 1),
