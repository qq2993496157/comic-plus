import { defineComponent, openBlock, createElementBlock, normalizeClass, normalizeStyle, createCommentVNode, createElementVNode } from "vue";
...
const _hoisted_2 = /* @__PURE__ */ createElementVNode("path", {
  d: "M287.8 288m-96 0a96 96 0 1 0 192 0 96 96 0 1 0-192 0Z",
  fill: "#d6d6d6",
  "p-id": "7084"
}, null, -1);
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["cu-skeleton-item", __props.shape ? "is-" + __props.shape : void 0]),
        style: normalizeStyle({ "--cu-skeleton-size": __props.size })
      }, [
        __props.shape === "image" ? (openBlock(), createElementBlock("svg", _hoisted_1, _hoisted_4)) : createCommentVNode("", true)
      ], 6);
    };
  }
});
