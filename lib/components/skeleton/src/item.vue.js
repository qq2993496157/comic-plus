  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(["cu-skeleton-item", __props.shape ? "is-" + __props.shape : void 0]),
        style: vue.normalizeStyle({ "--cu-skeleton-size": __props.size })
      }, [
        __props.shape === "image" ? (vue.openBlock(), vue.createElementBlock("svg", _hoisted_1, _hoisted_4)) : vue.createCommentVNode("", true)
      ], 6);
    };
  }
});
